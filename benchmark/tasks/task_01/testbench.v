...
// Testbench for picorv32_pcpi_mul — drives PCPI interface directly
...
module testbench;
    ...
    // RISC-V M-extension instruction encodings (R-type, opcode=0110011, funct7=0000001)
    ...
    initial begin
        ...
        // mulh: result = (signed(rs1) * signed(rs2))[63:32]
        ...
        // mulhsu: result = (signed(rs1) * unsigned(rs2))[63:32]
        ...
        // mulhu: result = (unsigned(rs1) * unsigned(rs2))[63:32]
